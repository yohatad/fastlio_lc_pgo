...
def generate_launch_description():
    ...
    declare_save_directory_cmd = DeclareLaunchArgument(
        'save_directory', default_value='/home/yoha/Lidar/run_park_lc/pgo_output/',
    ...
    fast_lio_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            # park's /points_raw + /imu_raw - same Velodyne VLP-16 setup as corridor.
    ...
    pgo_node = Node(
        ...
        parameters=[{
            ...
            # keyframe selection - open outdoor parking lot, wider spacing than
            # the tight indoor corridor run is fine
            'keyframe_meter_gap': 2.0,
            'keyframe_deg_gap': 10.0,

            # Scan Context - outdoor open space, use library defaults instead
            # of corridor's tightened indoor radius
            'sc_dist_thres': 0.2,
            'sc_max_radius': 80.0,

            # loop closure - wider search radius for an outdoor loop
